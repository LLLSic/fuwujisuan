...
func init() {
	...
	infolog = getLogFile("/src/demo/data/info.log")
	errlog = getLogFile("/src/demo/data/error.log")
...
func GetGOPATH() *string {
	...
	for _, v := range goPath {
		if _, err := os.Stat(filepath.Join(v, "/src/demo/data/meetinginfo")); !os.IsNotExist(err) {
			return &v
		}
	}
	return nil
